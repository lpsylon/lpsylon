...
public class CompanyDaoTestSuite {
    ...
    public void testNamedQueries() {
        ...
        List<Company> companiesByFirstThreeLetters = companyDao.retrieveCompaniesByFirstThreeLetters("Sof%");

        //Than
        Assertions.assertEquals(1, employeesByLastname.size());
        Assertions.assertEquals(1, companiesByFirstThreeLetters.size());
    }
}
